    ...
    <div className='bg-white rounded-lg shadow-md w-full max-w-sm mx-auto'>
      ...
      <div className='p-6'>
        ...
        <div className='mb-6'>
          ...
          <input readOnly defaultValue="" value={response.secret} className='w-full border rounded mt-2 text-xs text-gray-600 p-4' onClick={copyClipboard} />
        </div>
        <button onClick={onSetupComplete} className='w-full bg-blue-500 text-white
        py-2 rounded-md'>Continue to verification</button>
      </div>
    </div>
  )
}
